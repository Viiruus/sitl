...
const inputPath = '/tmp/brigadedukiff-moniteurs-2026-04-22.json'
const outputDir = '/tmp/brigadedukiff-profile-qrs-2026-04-22'
const targetSlug = 'mael-chastin'
...
const main = async () => {
  ...
  const guide = guides.find((entry) => entry?.slug === targetSlug)

  if (!guide) {
    throw new Error(`Guide introuvable pour slug=${targetSlug}`)
  }
