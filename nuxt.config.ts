...
export default defineNuxtConfig({
  ...
  runtimeConfig: {
    ...
    vercelAnalyticsTeamSlug: process.env.VERCEL_ANALYTICS_TEAM_SLUG || process.env.VERCEL_TEAM_SLUG || '',
    public: {
  ...
  routeRules: {
    ...
    '/memoire-accueil': { robots: false, headers: { 'X-Robots-Tag': 'noindex, nofollow' } },
    ...
    '/moniteurs/analytics': { robots: false, headers: { 'X-Robots-Tag': 'noindex, nofollow' } },
    '/moniteurs/cgu': { headers: { 'X-Robots-Tag': 'noindex, nofollow' } },
    '/moniteurs/aventures/**': { headers: { 'X-Robots-Tag': 'noindex, nofollow' } },
    '/moniteurs/articles/**': { headers: { 'X-Robots-Tag': 'noindex, nofollow' } },
  },
  sitemap: {
