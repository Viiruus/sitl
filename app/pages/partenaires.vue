...
<template>
  <div class="min-h-screen bg-[#f7f7f5] text-[#242424]">
    ...
    <main class="mx-auto w-full max-w-7xl px-6 py-20 sm:py-28 lg:px-8">
      <ul role="list" class="grid items-start gap-8 sm:grid-cols-2 lg:grid-cols-3">
        <li v-for="partner in partners" :key="partner.name">
          <article class="group mx-auto max-w-[340px] overflow-hidden rounded-[14px] border border-[#e6e6e6] bg-white shadow-[0_2px_10px_rgba(0,0,0,0.06)] transition duration-200 hover:-translate-y-0.5 hover:shadow-[0_8px_20px_rgba(0,0,0,0.10)] sm:mx-0">
            <a
